...
# you can use.
# dat <- load_met_excel(path = "../data/ExperimentData.xlsx")
...
For experiments with previously processed data, 
...
met_est_heatmap(strat_pairwise$Female, dat,
    ...
    main = "Log fold change heatmap", show_rownames = TRUE
)
...
met_p_heatmap(strat_pairwise$Female, dat,
    interactive = TRUE, show_rownames = TRUE,
