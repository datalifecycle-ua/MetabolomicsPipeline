...
targeted metabolomics experiments. In this vignette we demonstrate how 
...
### Targeted metabolomics data as a SummarizedExperiment

Tareted metabolomics experiments leverage multiple data tables for analysis.
The datasets needed for the downstream
analysis are the sample metadata, chemical annotation, and peak data.
...
# you can use.
# dat <- load_met_excel(path = "../data/Metabolon.xlsx")
...
peak_med <- median_standardization(peak_data = dat@assays@data$peak)
